...
import InputOld from '../input/InputOld.component';
import { StyledSearchOld } from './SearchOld.styled';
import ListOld from '../list/ListOld.component';
...
interface SearchProps {
    ...
    createCustomItem?: (value: string) => void;
    showTags?: boolean;
    disabled?: boolean;
    isRemovable?: boolean;
...
const SearchOld = ({
    ...
    return (
        <StyledSearchOld ref={refSearch} isOverflowsPage={isOverflowsPage}>
...
export { SearchOld, type ItemListType };
