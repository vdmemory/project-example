...
import { StyledProgressBar } from './ProgressBarOld.styled';
...
const ProgressBarOld = ({
    ...
    return (
        <StyledProgressBar className={className} data-testid={'progress-bar'}>
...
export { ProgressBarOld, type ProgressBarType };
